...
const Navbar = () => {
  return (
    <nav className="flex items-center justify-between px-3 py-5 sm:px-10">
      ...
      <form className="relative overflow-hidden  text-sm text-primary sm:text-2xl md:text-xl">
        <FontAwesomeIcon
        ...
        <input
          type="text"
          className="w-full rounded-3xl bg-primary/10 py-2 pl-12 pr-16 font-semibold outline-none placeholder:text-text/20 focus:bg-primary/[0.13] sm:pr-24 md:w-auto md:pr-[8.1rem] "
          placeholder="Search Github Username"
        />
        <button className="absolute bottom-0 right-0 top-0  w-fit rounded-3xl bg-primary text-center font-extrabold text-background/80 transition-all duration-500 ease-in-out hover:bg-[#b899e6] hover:text-background/90 md:w-1/5">
